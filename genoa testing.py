...
total_social_media_followers = 458 # e.g., 787 for 787k followers
...
city_gdp_per_capita_usd = 43705  # e.g., 15000 per person
...
operating_income = 79700
payroll = 65702
profit_before_tax = -45915
max_profit_before_tax = -25745
min_profit_before_tax = -66085
profit_before_tax_norm = ((profit_before_tax - min_profit_before_tax)/ (max_profit_before_tax - min_profit_before_tax))
print (profit_before_tax_norm)
...
plt.hist(club_valuation, bins=50, color='skyblue', edgecolor='black')
...
print (f"Median Club Valuation: {np.median(club_valuation):,.5f}")
print (f"Mean Club Valuation: {np.mean(club_valuation):,.5f}")
